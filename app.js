...
function proceedToCheckout() {
    ...
    // Salva il carrello e il totale in localStorage per il checkout
    localStorage.setItem('pendingOrder', JSON.stringify({
        items: cart,
        total: total.toFixed(2)
    }));

    // Apri la pagina di checkout Bonifico
    window.location.href = '/checkout-bonifico.html';
}
...
function openAuth() {
    ...
    container.innerHTML = `
        ...
        <div style="text-align: center; margin: 20px 0;">
            ...
            <button onclick="loginWithGoogleFirebase()" class="btn" style="width: 100%; background: white; color: #333; border: 1px solid #ddd; display: flex; align-items: center; justify-content: center; gap: 10px;">
