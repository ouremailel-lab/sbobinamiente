...
function openAuth() {
    ...
    container.innerHTML = `
        ...
        <div style="text-align: center; margin: 20px 0;">
            <p style="color: #888; margin-bottom: 16px;">oppure</p>
            <button onclick="loginWithGoogleFirebase()" class="btn" style="width: 100%; background: white; color: #333; border: 1px solid #ddd; display: flex; align-items: center; justify-content: center; gap: 10px; margin-bottom: 10px;">
            ...
            <button onclick="loginWithAppleFirebase()" class="btn" style="width: 100%; background: black; color: white; border: none; display: flex; align-items: center; justify-content: center; gap: 10px;">
